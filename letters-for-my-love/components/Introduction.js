...
export default function Introduction({ onContinue }) {
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream via-warm-white to-rose-cream flex items-center justify-center px-4 py-16">
      <motion.div
      ...
      >
        <div className="bg-cream/80 backdrop-blur-sm rounded-3xl p-10 shadow-luxury border border-crimson/20">
          <div className="text-center mb-8">
            <span className="text-soft-gold text-sm tracking-[0.3em] uppercase font-light">Introduction</span>
            <h2 className="font-serif text-4xl text-deep-crimson mt-2">A Gift from the Heart</h2>
          ...
          <div className="space-y-5 text-dark-charcoal/70 font-light leading-relaxed">
            ...
            <p className="text-crimson font-serif text-xl italic">
          ...
          <div className="mt-10 text-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onContinue}
              className="px-10 py-4 bg-gradient-to-r from-deep-crimson to-ruby text-white rounded-full font-medium shadow-luxury hover:shadow-red-glow transition-all duration-300"
            >
              Continue →
            </motion.button>
          </div>
