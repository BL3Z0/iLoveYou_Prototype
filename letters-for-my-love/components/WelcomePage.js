...
export default function WelcomePage({ onMusicChoice, onBegin, isMusicEnabled }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream via-warm-white to-cream flex items-center justify-center px-4">
      <motion.div
      ...
      >
        {showMusicPrompt ? (
          <motion.div
            ...
            className="bg-warm-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-luxury border border-soft-gold/30"
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-deep-rose to-burgundy text-white rounded-full font-medium shadow-luxury hover:shadow-rose-glow transition-all duration-300 transform hover:scale-105"
              >
                🎵 Play with Music
              </button>
              <button
          ...
          <>
            ...
            >
              ...
              <h1 className="font-serif text-5xl md:text-7xl text-burgundy mb-4">
                Happy 20th Birthday,
                <span className="block text-deep-rose mt-2">[Her Name]</span>
              </h1>
              ...
              <p className="text-2xl text-deep-rose font-light mb-8">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={onBegin}
                className="px-10 py-4 bg-gradient-to-r from-deep-rose to-burgundy text-white rounded-full text-lg font-medium shadow-luxury hover:shadow-rose-glow transition-all duration-300"
              >
                Begin Your Journey ✨
              </motion.button>
            </motion.div>
